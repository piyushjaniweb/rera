    ...
    <div className='font-helvetica'>
      <div class="bg-gradient-to-r from-violet-950 via-indigo-900 to-indigo-800 lg:h-[400px] rounded-b-4xl flex flex-col lg:flex-row lg:py-8 lg:py-0 px-4 lg:px-40 items-center justify-center">
        <div className="py-8 lg:pt-0 w-auto lg:w-3/5 text-white text-center">
          <H2 className='!text-4xl lg:leading-[50px]'>Become a part of <span className='lora'>our team</span></H2>
          <H3 className='!text-md text-white py-8'>We are a dynamic group of experts on a mission to innovate and lead in the pharmaceutical distribution industry. Join us as together we shape the future of healthcare and make a meaningful difference worldwide.</H3>
