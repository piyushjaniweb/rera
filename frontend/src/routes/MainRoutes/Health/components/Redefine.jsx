...
const Redefine = () => {
    ...
    return (
        <div className='bg-[#ebecef] py-10 font-helvetica px-4'>
            <H2 className='text-center py-6'>Collaborate for a Healthier Future</H2>
            <H3 className='text-center lg:!mx-[500px] !text-base !text-slate-600 !leading-7'>Pharmarack has cultivated strong partnerships across the developmental ecosystem to support in addressing key issues pertaining to Public Health</H3>
