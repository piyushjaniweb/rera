...
const Redefine = () => {
    ...
    return (
        <div className='bg-white py-10 font-helvetica px-4'>
            <p className='text-center font-bold text-sm text-primary'>Global Presence</p>
            <H2 className='text-center py-6'>Explore our  <span className='lora'>office locations </span></H2>
            <H3 className='text-center lg:!mx-[500px] !text-base !text-slate-600 !leading-7'>From bustling city centers to innovative hubs, our offices reflect the energy of our team. Feel free to visit us if you're in the area.</H3>
