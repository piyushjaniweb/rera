...
const Redefine = () => {
    ...
    return (
        <div className='bg-[#ebecef] py-10 font-helvetica'>
            <H2 className='text-center py-6'>A growth platform for
            <span className='text-primary'> diverse stakeholders</span></H2>
            {/* <H3 className='text-center !mx-[500px] !text-base !text-slate-600 !leading-7'>Empowering Chemists and Distributors with superior technology to futureproof their businesses.</H3> */}
