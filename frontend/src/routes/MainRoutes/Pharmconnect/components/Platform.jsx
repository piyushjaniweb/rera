...
const Platform = () => {
    ...
    return (
        <div className="lg:my-10 h-[400px] lg:h-[600px] bg-white flex justify-center items-center font-helvetica">
            <div className="w-[330px] py-8 lg:py-0 lg:h-[500px] bg-[#ebecef]  lg:w-[1200px] rounded-3xl flex">
